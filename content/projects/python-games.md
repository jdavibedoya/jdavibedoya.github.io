...
summary: "Games developed as part of the 'An Introduction to Interactive Programming in Python' course by Rice University."
tags: ["Python", "Games"]
cover:
...
## 🕹️ The Games
Built with **Python** and running on the **CodeSkulptor** browser environment.

> **How to Play:** Click the links below to open the environment. Once loaded, press the **Play button ( ▶ )** in the top-left corner.

---

### ♠️ Blackjack
A logic-complete implementation of the classic casino card game.

**Objective:** Beat the dealer to a count of 21 without busting.  
**Controls:** `Deal` to start; `Hit` to take a card; `Stand` to hold your hand.
...
### 🚀 Spaceship
A physics-based arcade shooter utilizing vector mathematics for movement and collision.
